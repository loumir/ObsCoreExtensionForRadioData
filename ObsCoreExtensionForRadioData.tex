...
different extensions and recomand how to expose them in the compliant services, we don't define
any standardID for the extension yet. The discovery of the services and schema containing the
radio extension  table MUST be done using the table_name only as stated below.
