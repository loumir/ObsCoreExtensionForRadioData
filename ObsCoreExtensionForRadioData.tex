...
\begin{abstract}
This is a proposed extension to the ObsCore specification for discovery and selection of radio data.
\end{abstract}
...
to allow data providers to describe their radio data within the  ObsTAP framework.
...
Similarly, the resolution power quantity, commonly provided to describe optical spectroscopic data, is not relevant in the radio domain and it is generally not used.
