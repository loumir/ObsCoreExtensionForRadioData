...
join between the basic ObsCore table  and the obscore_radio table
use the utype
$$
...
Discovering the obscore_radio table alone would be  irrelevant  because querying this
extension table per se doesn't make sense.
However, being sure our ivoa schema  contains both the ObsCore table and the obscore_radio table,
